        ...
        <div className="relative flex flex-col items-center justify-center py-4 sm:py-8">
          ...
          <motion.div className="relative z-10 flex flex-col items-center gap-6 sm:gap-8 w-full">
            <div className="glass-card w-full max-w-[320px] rounded-2xl p-3 backdrop-blur-md flex flex-col items-center gap-2 shadow-lg shadow-cyan-900/10 mb-2">
                ...
                <div className="w-full grid grid-cols-[40px_1fr] gap-2 px-2 items-center"><span className="text-[10px] text-cyan-500/70 text-left">+時</span><span className="text-sm font-bold text-white font-mono text-right" title="陽曆出生時數縮減">{formatRawNum(data.solarBirthHour)}</span></div>
                <div className="w-full grid grid-cols-[40px_1fr] gap-2 px-2 items-center"><span className="text-[10px] text-cyan-500/70 text-left">+分</span><span className="text-sm font-bold text-white font-mono text-right" title="陽曆出生分鐘縮減">{formatRawNum(data.solarBirthMinute)}</span></div>
                <div className="w-full grid grid-cols-[40px_1fr] gap-2 px-2 items-center"><span className="text-[10px] text-purple-500/70 text-left">-時</span><span className="text-sm font-bold text-slate-300 font-mono text-right" title="陰曆出生時數縮減">{formatRawNum(data.lunarBirthHour)}</span></div>
                <div className="w-full grid grid-cols-[40px_1fr] gap-2 px-2 items-center"><span className="text-[10px] text-purple-500/70 text-left">-分</span><span className="text-sm font-bold text-slate-300 font-mono text-right" title="陰曆出生分鐘縮減">{formatRawNum(data.lunarBirthMinute)}</span></div>
            </div>
